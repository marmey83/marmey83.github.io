<?php 
  if(isset($_POST['email'])){
	...
	$receiver="meyer.martina@gmail.com";
	$subject="Contact from martina-meyer.ch";
	...
	<td align='left' valign='top' style='border-top:1px solid #dfdfdf; border-bottom:1px solid #dfdfdf; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000; padding:7px 0 7px 5px;'>".($comment)."</td>
	</tr>
	</table>
	</body>
	</html>
...
$headers .= 'From: <'.$name.'>' . "\r\n";
   ...
   {	
   	 //Fail Message
      echo "The message could not been sent! Please try again.";
   }
